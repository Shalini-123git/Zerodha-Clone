...
facilitate transactions, but actively help you do better with your money.
                ...
                <div className="col-6">
                    ...
                    <div className="text-center">
                        <a className="m-5" href="" style={{textDecoration: "none"}}>Explore our products <i class="fa-solid fa-arrow-right-long"></i></a>
                        <a className="m-5" href="" style={{textDecoration: "none"}}>Try kite demo <i class="fa-solid fa-arrow-right-long"></i></a>
                    </div>
                </div>
            </div>
        </div>
