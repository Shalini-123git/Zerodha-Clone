            ...
            <div className="container border-top mt-5">
                <div className="row">
                    <div className="col">
                        ...
                        <p>
                            C 2010 - 2024, Not Zerodha Broking Ltd.
                            All rights reserved.
                        </p>
                    </div>
                    <div className="col">
                ...
                <div className="mt-5 text-muted" style={{fontSize: "14px"}}>
                    <p>
                        ...
                        Registration no .: IN-DP-100-2015 Commodity Trading through Zerodha Commodities Pvt. Ltd.
                        MCX: 46025 - SEBI Registration no .: INZ000038238 Registered Address: Zerodha Broking
                        Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th
                        Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities
                        broking please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please
                    ...
                    <p>
                        ...
                        SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the
                        same process again when you approach another intermediary." Dear Investor
                        subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO
